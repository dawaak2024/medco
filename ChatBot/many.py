...
def load_intents_data():
    intents_file = "D:/Gradution Project/ChatBot/intents.json"
    try:
...
if os.path.exists(model_file):
    ...
    try:
        ...
        logging.info("Retraining the model due to mismatch in model architecture and weights")
...
if __name__ == '__main__':
    ...
    app.run(debug=True, host='192.168.1.13', port=443)
